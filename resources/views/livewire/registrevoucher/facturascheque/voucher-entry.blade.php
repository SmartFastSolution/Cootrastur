<div>
    @include('cruds.vouchers.facturas.modal.modalvoucher')
    <div class="card-body">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createFacturas" onclick="mostrarBoton();"> Ingresar Factura</button>         
    </div>
                    ...
                    @if ($data->isNotEmpty())
                        @foreach ($data as $p)
                          <tr data-entry-id="{{ $p->id }}">
                                ...
                                <td width="10px">
                                    <button class="btn btn-success" data-toggle="modal" data-target="#createFacturas"
