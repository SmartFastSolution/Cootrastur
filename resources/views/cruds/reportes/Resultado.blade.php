...
<h1 class="text-center font-weight-bold">Balance Pérdidas y Ganacias</h1>
<br>
<div>
     <div class="card">
         <div class="card-body">
...
function mensaje(){
    ...
    function descargaReporte() {
        $('#descargaexcel a').prop('href', '{!!  route('reportes.verresult') !!}?fechaini='+$("#fechaini").val()+'&fechafin='+$("#fechafin").val());
    }
